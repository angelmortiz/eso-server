...
export const ADDED_SUCCESSFULLY_ID = (_id: string): IResponse => {
  return responseObject(
    SUCCEED,
    'success',
    'Document added successfully to the database.',
...
export const UPDATED_SUCCESSFULLY = (): IResponse => {
  return responseObject(
    SUCCEED,
    'success',
    'Document updated successfully in the database.'
  );
};

export const UPDATED_SUCCESSFULLY_ID = (_id: string): IResponse => {
  return responseObject(
    SUCCEED,
    'success',
    'Document updated successfully in the database.',
...
export const DELETED_SUCCESSFULLY = (): IResponse => {
  return responseObject(
    SUCCEED,
    'success',
    'Document deleted successfully from the database.'
  );
};

export const DELETED_SUCCESSFULLY_ID = (_id: string): IResponse => {
  return responseObject(
    SUCCEED,
    'success',
    'Document deleted successfully from the database.',
...
export const FETCHED_SUCCESSFULLY = (body: any): IResponse => {
  return responseObject(
    SUCCEED,
    'success',
    'Document(s) fetched successfully.',
    body
  );
};
...
export const USER_AUTHENTICATION_RESPONSE = (
  ...
  return responseObject(
    SUCCEED,
    isUserAuthenticated ? 'success' : 'failed',
    message,
    { isUserAuthenticated }
  );
};
