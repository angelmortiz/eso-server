...
import { getHome } from './controllers/homeController'; //imports logic to load home page
import { get404 } from './controllers/errorsController'; //imports logic to load home page
...
//error handling
exp.use('/', get404); //navigates to 404 error if the address provided does not exist
